...
//  Disciplina: INF029 - Laborat√≥rio de Programa√ß√£o
//  Professor: Renato Novais - renato@ifba.edu.br

//  ----- Orienta√ß√µes gerais -----
//  Descri√ß√£o: esse arquivo cont√©m exemplos de testes das quest√µes do trabalho.
//  o aluno pode incrementar os testes

//  Copyright ¬© 2016 Renato Novais. All rights reserved.
// √öltima atualiza√ß√£o: 19/08/2016
...
int main(){
    ...
    printf("\n****** Verificando a localidade corrente ********\n\n");
     ...
     printf("N„o È possÌvel usar acentuaÁ„o ou Á corretamente...\n\n");

     printf("\n****** Alterando para a localidade do sistema ********\n\n");

     //alterando para o padr„o do sistema operacional
     printf("A localidade corrente agora È %s \n",setlocale(LC_ALL,""));
     printf("Agora n„o tem mais problema algum!\n");
     printf("J· posso usar acentuaÁ„o e tambÈm o caracter Á...\n\n\n");
...
void testQ4(){
    ...
    strcpy(strTexto,"Laboratorio de programacao: para ratos de programa√ß√£o");
    ...
    strcpy(strBusca,"mui");
    printf("%d\n",q4("Ol√°, o mundo √© muito grande. Tem muitas pessoas, e muitos problemas", "mui", posicoes) == 3);
    printf("%d\n",posicoes[0]==16);
    printf("%d\n",posicoes[1]==17);
    printf("%d\n",posicoes[2]==34);
    printf("%d\n",posicoes[3]==36);
